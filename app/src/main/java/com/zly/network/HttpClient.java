package com.zly.network;

import android.text.TextUtils;


import com.zly.utils.ContextUtil;
import com.zly.utils.CookieUtil;
import com.zly.utils.LogUtils;
import com.zly.utils.NetUtil;
import com.zly.utils.UserAgentUtils;
    ...
    public static void initOkHttpClient() {
        if (mOkHttpClient == null) {
            synchronized (HttpClient.class) {
                ...
                // 指定缓存路径,缓存大小100Mb
                Cache cache = new Cache(new File(com.zly.app.YuYouBangApp.getContext().getCacheDir(), "YuYouBang"),
                        1024 * 1024 * 100);
