...
import com.zly.listener.OnClickListener;
 ...
 */
public abstract class ToolBarActivity extends com.zly.activity.base.UmengActivity {
    ...
    public class HeaderBuilder {
        public void setTitle(int resId) {
            ...
            String title = com.zly.utils.ContextUtil.getInstance().getResources().getString(resId);
        ...
        public void setLeftOperate(int imgResId, com.zly.listener.OnClickListener listener) {
