...
public class MainActivity extends BaseActivity implements com.zly.fragment.MyFragmentTabHost.OnTabClickListener, TabHost.OnTabChangeListener {
    com.zly.fragment.MyFragmentTabHost mTabHost;
    RadioGroup mTabRg;
    ...
    void initTab() {
        ...
        TabIndicator learnTabView = new com.zly.view.TabIndicator(this);
